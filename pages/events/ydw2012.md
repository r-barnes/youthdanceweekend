...
* [Youth Dance Weekend Contra Dance #3](https://www.youtube.com/watch?v=U5-oWuJwhZw) — Saturday night contra, Open Band with Matt Johnson calling
* [Youth Dance Weekend Contra Dance #6](https://www.youtube.com/watch?v=RYjqfBc-8tQ) — Saturday night contra, Riptide with Mary Wesley calling "A Bevy of Butterflies"
* [Youth Dance Weekend English Dance #1](https://www.youtube.com/watch?v=Ix3GICbDSRc) — Friday night English, Riptide with Miriam Newman calling

## Charts & Graphs

### 2012 Registration Survey

YDW 2012 filled up within 14 hours, generating significant discussion about fairness and accessibility. The committee issued a statement and survey to gather community opinions on registration. **N = 75 responses** (roughly 17% response rate from ~450-person email list). On average, respondents had attended YDW 1.6 times.

**Registration status of survey respondents:**
- 67% registered for YDW 2012
- 17% were on the waitlist
- 7% considered joining the waitlist
- 9% were not interested in attending

**How well did the 2012 process work?** (1–4 scale, Horrible to Excellent)
- 70% found pre-registration communication "fine" or "excellent"
- 60% said the opening date and time were "fine" or "excellent"
- 80% had no problems using the website
- **75% said the speed at which registration filled was less than "fine" — 14% called it "horrible"**

**Who should be able to attend?** (1–5, Unimportant to Very Important)
- **94% said it was "important" or "very important" that newcomers be able to attend** — no one said it was unimportant
- ~60% said it was "very important" that they personally be able to attend
- ~60% said attending with friends was important
- ~60% said it was only "somewhat important" or "unimportant" that prior-year returnees attend

**Newcomer percentages by year:**

| Year | Total | 1st-Timers | % New |
|------|-------|-----------|-------|
| 2008 | 179 | 179 | 100% |
| 2009 | 145 | 96 | 66% |
| 2010 | 151 | 78 | 52% |
...
**Support for registration systems:**
- 49% support or strongly support first-come-first-served (FCFS)
- 40% support or strongly support a lottery
- **73% believe reserved spots for newcomers should exist**
- Overwhelming majority preferred not to pay up front to join the waitlist

**Statistical findings:**
- Strong support for newcomers correlated with support for reserved slots (Spearman's ρ = 0.4, p < 0.001)
- Those prioritizing their own attendance more strongly favored FCFS (ρ = 0.39, p < 0.001)
- Support for FCFS negatively correlated with support for lottery (ρ = -0.41, p < 0.001)
- Despite the correlation, the greatest number of people actually supported **both** FCFS and lottery

**Conclusions:** The committee took away four main points: (1) newcomers must continue to be able to attend; (2) the registration window should be open longer; (3) waitlist sign-up should be free; (4) support for FCFS and lottery are roughly equal but intense. These findings led directly to implementing the **lottery system** starting in 2013.
...
Registration was first-come-first-served in 2012; it filled in 14 hours, prompting the switch to a lottery system in 2013.
