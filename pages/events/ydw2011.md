...
For a tour schedule, audio clips, and booking information, visit Anadama.
...
For audio clips and more info check out [Double Apex on Myspace](https://julievallimont.com/).

## Notes

2011 was the first year that YDW was held at Kinhaven Music School in Weston, VT. In previous years, the event had been hosted at Timberlake Camp in Plymouth, VT; however, Hurricane Irene caused significant damage to that facility, necessitating the move to Kinhaven, which has remained the home of YDW ever since.

## Charts & Graphs

### Payment System Change Data (2011)

In 2011 YDW switched from age-based registration fees to a "pay-what-you-can" system. While there was concern that the new system would be financially risky, the data showed it was a viable model.
...
- Minimum: $90
- At cost: $130
- Sponsor: $170 ($130 + $40 to cover one person paying minimum)
- 2× Sponsor: $210 ($130 + $80 to cover two people paying minimum)
...
Including t-shirt sales and other revenue, YDW ended without losses. The pay-what-you-can experiment worked.

*(Chart images from the original post are no longer available.)*

## Pricing

First year of the **pay-what-you-can** system, replacing age-based pricing.

- Minimum: **$90**
- At-cost: **$130** ($30 food, $35 venue, $65 staff/misc)
- Sponsor ($170): covers one person at minimum
- 2× Sponsor ($210): covers two people at minimum

Average payment: **$128.50** — 30% paid below cost, 36% at cost, 33% above cost.
